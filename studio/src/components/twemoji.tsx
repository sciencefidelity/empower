...
export const Lotus = () => (
  ...
  >
    ...
    <path
      fill="#F4ABBA"
      d="M18 21.182c-5.17-5.25-3.322-6.513-14.294-10.218a.5.5 0 0 0-.62.276c-1.804 4.216-1.369 7.359 4.201 8.894c-2.141-.014-4.393.249-6.813.492a.5.5 0 0 0-.447.55c.325 3.099 3.617 7.551 11.214 5.121A2.68 2.68 0 0 0 11 27.392c0 2.683 5.164 4.224 6.62 4.605a1.528 1.528 0 0 0 .76 0c1.456-.381 6.62-1.922 6.62-4.605c0-.387-.089-.751-.241-1.094c7.596 2.43 10.888-2.022 11.214-5.121a.5.5 0 0 0-.447-.55c-2.42-.243-4.671-.507-6.813-.492c5.57-1.535 6.004-4.678 4.201-8.894a.5.5 0 0 0-.62-.277C21.322 14.668 23.17 15.932 18 21.182z"
    ></path>
    <path
      fill="#EA596E"
      d="M26.975 8.577a.56.56 0 0 0-.931.007l-3.259 4.961l-.426-.001c0-.023.005-.044.005-.067c0-3.677-3.182-5.798-4.111-6.339a.502.502 0 0 0-.503 0c-.929.541-4.113 2.662-4.113 6.339c0 .023.005.044.005.067l-.426.001l-3.26-4.961a.56.56 0 0 0-.931-.006c-1.417 2.086-2.438 4.673-1.86 7.472c1.098 5.323 5.866 7.944 10.837 6.769c4.968 1.175 9.736-1.445 10.834-6.769c.577-2.8-.444-5.387-1.861-7.473z"
    ></path>
    <path
      fill="#F4900C"
      d="m15.142 21.727l-2.597-7.636h10.91l-2.597 7.636z"
    ></path>
    <ellipse cx="18" cy="14.091" fill="#FFDC5D" rx="5.455" ry="1.636"></ellipse>
    <path
      fill="#EA596E"
      d="M18.001 26c-2.411 0-4.365-2.309-4.365-5.748c0-3.797 3.167-5.992 4.106-6.558a.502.502 0 0 1 .518 0c.938.567 4.104 2.761 4.104 6.559c0 3.438-1.954 5.747-4.363 5.747z"
    ></path>
    <path
      fill="#EF8294"
      d="M32 14.716a.503.503 0 0 0-.617-.491c-2.67.644-13.348 3.72-13.382 11.737c-.035-8.017-10.713-11.093-13.383-11.737a.499.499 0 0 0-.618.491c.021 2.451.999 11.282 13.998 11.284h.004C31.001 25.998 31.979 17.167 32 14.716z"
    ></path>
  </svg>
)

export const LotusPosition = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    aria-hidden="true"
    role="img"
  ...
  >
    <path
      fill="#4289C1"
      d="M28.632 30.563c-.178-1.426-1.568-1.931-2.257-1.931c-.884 0-2.992 1.106-3.375-.585l-.037-.183l-9.91-.012l-.053.184c-.375 1.708-2.492.596-3.378.596c-.689 0-2.079.505-2.257 1.931C7.365 30.563 14.13 33 18 33c3.873 0 10.632-2.437 10.632-2.437z"
    ></path>
    <path
      fill="#FFDC5D"
      d="M12.497 16.024c-.674-.134-1.336 1.309-1.47 1.983L9.846 23.02c-1.619 1.166-1.57 3.454-2.808 4.512c-.171.146-.949.766-1.203 1.325c-.336.738.22.444.045.695c-.406.584-.414 1.478-.127 1.686l.373.1c.557.403 2.081-1.336 2.281-2.302c.3-1.443 3.075-3.25 3.589-4.653c.006-.017.007-.029.013-.046a1.23 1.23 0 0 0 .204-.469l1.266-6.375a1.252 1.252 0 0 0-.982-1.469zm17.59 13.588c-.175-.251.437-.016.101-.754c-.255-.56-1.089-1.179-1.259-1.325c-1.246-1.064-1.133-3.377-2.781-4.535l-1.176-4.99c-.134-.674-.795-2.117-1.47-1.983a1.255 1.255 0 0 0-.983 1.47l1.266 6.375c.038.191.125.355.236.501l.004.014c.513 1.402 3.289 3.209 3.589 4.653c.201.967 1.725 2.706 2.281 2.302l.373-.1c.29-.21.226-1.044-.181-1.628z"
    ></path>
    <path
      fill="#FFDC5D"
      d="M22.757 35.82c-1.04.089-2.02-.208-3 0c-.475.03-.802 0-1.277-.416s-8.287-1.515-9.713-2.465c-.658-.439-1.662-1.54-1.396-2.465c.263-.913 1.139-1.429 2.198-1.455c2.065-.051 6 2.941 8.851 4.04c.518.2.948-.052 1.604.119c.683.178 2.317-.555 3.149-.446c1.129.149 1.574.683 1.485 1.604c-.094.974-.861 1.395-1.901 1.484z"
    ></path>
    <path
      fill="#F9CA55"
    ...
    <path
      fill="#F9CA55"
      d="M7.371 30.474c.006-.02.016-.037.022-.056c.201.762.76 1.66 1.401 1.898c.802.297 7.247 2.198 8.049 2.287c.802.089 1.99.208 2.228.386c.238.178.861.238 1.366.119c.505-.119 1.782.356 2.436.208c.653-.148 1.604-.445 1.782-1.247c.003-.015.007-.022.011-.034c.004.096.003.195-.007.302c-.094.975-.861 1.396-1.901 1.485s-2.02-.208-3 0c-.475.03-.802 0-1.277-.416c-.475-.416-8.287-1.515-9.713-2.465c-.659-.441-1.663-1.543-1.397-2.467z"
    ></path>
    <path
      fill="#FFDC5D"
      d="M13.243 35.82c1.04.089 2.02-.208 3 0c.475.03.802 0 1.277-.416s8.287-1.515 9.713-2.465c.658-.439 1.662-1.54 1.396-2.465c-.263-.913-1.139-1.429-2.198-1.455c-2.065-.051-6 2.941-8.851 4.04c-.518.2-.948-.052-1.604.119c-.683.178-2.317-.555-3.149-.446c-1.129.149-1.574.683-1.485 1.604c.094.974.861 1.395 1.901 1.484z"
    ></path>
    <path
      fill="#77B255"
      d="M22.543 15h-9.06c-2.562 0-2.943 4.394-2.943 4.394l2.458.535s.31 3.589.271 5.27c-.038 1.682-.27 2.801-.27 2.801s1.912.394 5 .394s5-.394 5-.394s-.349-1.606-.349-2.978s.349-5.093.349-5.093l2.458-.535S25.105 15 22.543 15z"
    ></path>
    <path
      fill="#FFDC5D"
      d="M15.667 10.389v4.666c0 .312.553 1.488 2.333 1.488c1.781 0 2.333-1.214 2.333-1.488v-4.666h-4.666z"
    ></path>
    <path
      fill="#F9CA55"
      d="m20.333 9.774l-4.666.022v4.644s2.333 1.167 4.666 0V9.774z"
    ></path>
    <path
      fill="#FFDC5D"
      d="M22.954 3.966h-9.908v5.433a4.953 4.953 0 1 0 9.908 0V3.966z"
    ></path>
    <path
      fill="#C1694F"
      d="M19.982 12.057h-3.964s0 .991 1.982.991s1.982-.991 1.982-.991zM16.25 8.75h-1.5c-.137 0-.25-.113-.25-.25s.113-.25.25-.25h1.5c.138 0 .25.113.25.25s-.112.25-.25.25zm5 0h-1.5c-.138 0-.25-.113-.25-.25s.112-.25.25-.25h1.5c.138 0 .25.113.25.25s-.112.25-.25.25zm-4.241 1.326h1.982s0 .991-.991.991s-.991-.991-.991-.991z"
    ></path>
    <path
      fill="#FFAC33"
      d="M18 .953c3.385 0 5.5 2.579 5.5 4.728c0 2.149-.423 3.009-.846 2.149l-.846-1.719s-2.538 0-3.384-.86c0 0 1.269 2.579-1.269 0c0 0 .423 1.72-2.115-.429c0 0-1.269.86-1.692 3.008c-.117.597-.846 0-.846-2.149C12.5 3.532 14.192.953 18 .953"
    ></path>
  </svg>
)
